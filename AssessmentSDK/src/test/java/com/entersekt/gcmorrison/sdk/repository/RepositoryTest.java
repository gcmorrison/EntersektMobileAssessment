...
public class RepositoryTest implements RandomTestData {
    ...
    public void getAllCities() {
        ...
        // WHEN
        List<City> results = classUnderTest.getAllCities().blockingGet();
    ...
    public void getSpecificCityWhenItExists() {
        ...
        when(mockApi.getCities()).thenReturn(Single.just(Arrays.asList(randomCity(), expectedCity, randomCity())));
    ...
    public void getSpecificCityWhenItDoesntExist() {
        ...
        when(mockApi.getCities()).thenReturn(Single.just(Arrays.asList(randomCity(), randomCity())));
    ...
    public void getMallsOfCityWhenThereAre() {
        ...
        when(mockApi.getCities()).thenReturn(Single.just(Collections.singletonList(city)));
